...
kubectl create configmap projectmanager --from-file=projectmanager.yaml=config/projectmanager.yaml --dry-run=client -o yaml | kubectl replace configmap projectmanager -f -
kubectl create configmap groundwork --from-file=groundwork.yaml=config/groundwork.yaml --dry-run=client -o yaml | kubectl replace configmap groundwork -f -
